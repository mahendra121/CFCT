...
(function (root, factory) {
	...
	function JsonToCsv(_input, _config) {
		...
		function safe(str, col) {
			...
			var needsQuotes = (typeof _quotes === 'boolean' && _quotes) || (_quotes instanceof Array && _quotes[col]) || hasAny(str, Papa.BAD_DELIMITERS) ||
				str.indexOf(_delimiter) > -1 || str.charAt(0) === ' ' || str.charAt(str.length - 1) === ' ';
